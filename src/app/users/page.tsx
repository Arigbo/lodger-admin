                                ...
                                <TableRow key={user.id} className="group/row">
                                    <TableCell className="pl-10">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <Link href={`/users/${user.id}`} className="font-bold text-white tracking-tight hover:text-primary transition-colors cursor-pointer">
                                                    {user.name || 'Anonymous'}
                                                </Link>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-8 shadow-2xl relative">
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-xl font-black uppercase tracking-tighter">Message <span className="text-primary italic">User</span></h3>
                                <p className="text-sm font-bold text-white/40">Sending to: {selectedUser.name}</p>
                            </div>
                        </div>

                        <div className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black uppercase tracking-widest text-white/40 ml-4">Message Content</label>
                                <textarea
                                    value={messageText}
